...
resource "azurerm_resource_group" "impacta02" {
  name     = "impacta02"
  location = "eastus"
}

resource "azurerm_resource_group" "teste-importacao-impacta02" {
  name     = "teste-importacao-impacta02"
  location = "westus2"
}

resource "azurerm_virtual_network" "vnet" {
  name                = "vnet"
  location            = azurerm_resource_group.impacta02.location
  resource_group_name = azurerm_resource_group.impacta02.name
